...
from app.api.routes import channel  # Channel management (Pages, Groups, Auto Comment)
...
app.include_router(channel.router)  # Channel management (Pages, Groups, Auto Comment)
