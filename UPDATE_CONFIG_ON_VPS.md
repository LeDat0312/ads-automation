# 📝 UPDATE CONFIG.PY TRÊN VPS

## ✅ FILE CONFIG.PY HOÀN CHỈNH ĐÃ SỬA

Copy nội dung sau vào file `/home/adsuser/ads-automation/app/core/config.py`:

---

## 🚀 CÁCH 1: SỬA BẰNG NANO
...
**Xóa toàn bộ nội dung cũ và paste nội dung mới từ file đã sửa.**

**Lưu:** `Ctrl+X`, `Y`, `Enter`

---

## 🚀 CÁCH 2: TẠO FILE MỚI BẰNG CAT
...
# Tạo file mới (copy-paste toàn bộ nội dung từ file đã sửa)
...
1. ✅ **Xóa `@validator` decorator** - Gây conflict với Pydantic
2. ✅ **Đổi `parse_ad_account_ids` thành method thông thường** - Không phải validator
3. ✅ **Type hint `AD_ACCOUNT_IDS: str`** - Luôn là string
4. ✅ **Property `ad_account_ids_list`** - Parse từ string sang list khi cần

---

**Bây giờ hãy update file config.py trên VPS! 🚀**
