#!/bin/bash
# Script để pull code mới và restart service sau khi fix summary card
...
echo "   ✅ Summary card tính từ TOÀN BỘ adsets của view_mode"
echo "   ✅ Summary KHÔNG bị ảnh hưởng bởi prefix/search/status/pagination"
echo "   ✅ Summary chỉ bị ảnh hưởng bởi view_mode (Lead/E-Commerce) và date range"
echo "   ✅ Fix: Summary nhất quán với settings, không còn hiện tượng 'TỔNG ADSETS 34' nhưng bảng chỉ có '8 nhóm quảng cáo'"
