#!/bin/bash
# Script để pull code mới và restart service sau khi fix tất cả bugs (BUG 1, 2, 3, 4, 5)
...
echo "   ✅ BUG 1: Fix budget display for CBO - Hiển thị đúng campaign budget khi dùng CBO"
echo "   ✅ BUG 2: Fix sorting, cost metrics mapping, resize & sticky columns"
echo "   ✅ BUG 3: Fix E-Commerce view - % ADS và cost metrics hiển thị đúng"
echo "   ✅ BUG 4: Fix totals/averages footer row - ads_percent hiển thị đúng (nhân 100)"
echo "   ✅ BUG 5: Fix adset counting - Đếm đúng tổng, active, paused adsets"
