...
echo "   ✅ Summary tính từ toàn bộ adset_map_raw (không bị ảnh hưởng bởi filter)"
echo "   ✅ Bảng chỉ hiển thị rows có spend > 0 VÀ impressions > 0"
echo "   ✅ Fix checkouts_initiated: Dùng đúng omni_initiated_checkout cho Lead Gen"
echo "   ✅ Fix CBO budget inheritance: Hiển thị đúng campaign budget khi adset không có budget riêng"
echo "   ✅ Optimistic UI: Update budget không reload page, chỉ update state"
echo "   ✅ Fix onsite_conversion_post_save cho Lead Gen summary"
