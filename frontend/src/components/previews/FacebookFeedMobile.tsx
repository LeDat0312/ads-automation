...
export function FacebookFeedMobile({
  ...
  return (
    ...
    >
      ...
      {/* Reactions & Stats (giống Facebook) */}
      <div className="px-3 py-2.5 flex items-center justify-between text-[13px] text-gray-600 border-t border-gray-100">
        ...
        <div className="flex items-center gap-3">
          <span className="hover:underline cursor-pointer">4 bình luận</span>
          <span className="hover:underline cursor-pointer">1 lượt chia sẻ</span>
        </div>
      </div>

      {/* Action Buttons (giống Facebook) */}
      <div className="border-t border-gray-200 px-1 py-1 flex items-center">
        {/* Thích */}
