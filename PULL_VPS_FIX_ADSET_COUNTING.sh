#!/bin/bash
# Script để pull code mới và restart service sau khi fix adset counting
...
echo "   - Fix: Tính summary từ grouped_data/adset_map để đếm đúng adsets"
echo "   - Fix: Tổng chi tiêu sẽ chính xác hơn vì đếm đúng số lượng adsets"
echo "   - Fix: Summary metrics khớp với dữ liệu hiển thị trong bảng Chi Tiết Quảng Cáo"
